...
PROBABILITY_THRESHOLDS = {
    ...
    'M4_PURPLE': 0.15,    # M4圣保罗黄车漆: 0.13% (0.02-0.15)
    'M3_PURPLE': 1.45,    # M3曼岛绿车漆: 1.3% (0.15-1.45)
    'M2_PURPLE': 3.5,     # M2赞德福特蓝车漆: 2.05% (1.45-3.5)
    'GOLD': 8.9,         # 金色装备: 5.4% (3.5-8.9)
    'GREEN': 17.5,       # 绿色装备: 8.6% (8.9-17.5)
    # 蓝色装备: 82.5% (15.92-100)
}
